...
//         color: currentPrice > (existingData?.high || openingPrice) ? 'green' : currentPrice < (existingData?.low || openingPrice) ? 'red' : '',
//       };
//     });
...
//     () => [
//       { Header: 'Symbol', accessor: 'symbol' }, // Assuming 'symbol' is not provided in the data
